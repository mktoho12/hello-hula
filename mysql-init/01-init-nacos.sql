...
-- Grant privileges to hula_user
GRANT ALL PRIVILEGES ON nacos_config.* TO 'hula_user'@'%';
FLUSH PRIVILEGES;

USE nacos_config;

-- Nacos database schema
...
CREATE TABLE IF NOT EXISTS group_capacity (
  ...
  group_id varchar(128) NOT NULL DEFAULT '' COMMENT 'Group ID, blank is for cluster',
  ...
  max_size int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'max size of single configuration, unit is byte, 0 means use default',
  max_aggr_count int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'max number of aggregated sub-configurations',
  max_aggr_size int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'max size of aggregated sub-configurations, unit is byte, 0 means use default',
  max_history_count int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'max number of change history',
  gmt_create datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'creation time',
  gmt_modified datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'modification time',
  PRIMARY KEY (id),
